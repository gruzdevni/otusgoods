...
func (o *GetHealthOK) WithPayload(payload *models.DefaultStatusResponse) *GetHealthOK {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the get health o k response
func (o *GetHealthOK) SetPayload(payload *models.DefaultStatusResponse) {
	o.Payload = payload
}
...
/*
GetHealthInternalServerError Серверная ошибка
